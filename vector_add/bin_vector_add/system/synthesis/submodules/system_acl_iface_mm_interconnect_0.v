...
module system_acl_iface_mm_interconnect_0 (
	...
	wire          version_id_s_agent_rdata_fifo_out_valid;                               // version_id_s_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] version_id_s_agent_rdata_fifo_out_data;                                // version_id_s_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          version_id_s_agent_rdata_fifo_out_ready;                               // avalon_st_adapter:in_0_ready -> version_id_s_agent_rdata_fifo:out_ready
	...
	wire          acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_valid;          // acl_kernel_interface_kernel_cntrl_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_data;           // acl_kernel_interface_kernel_cntrl_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_ready;          // avalon_st_adapter_001:in_0_ready -> acl_kernel_interface_kernel_cntrl_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                     // avalon_st_adapter_001:out_0_valid -> acl_kernel_interface_kernel_cntrl_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                      // avalon_st_adapter_001:out_0_data -> acl_kernel_interface_kernel_cntrl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                     // acl_kernel_interface_kernel_cntrl_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                     // avalon_st_adapter_001:out_0_error -> acl_kernel_interface_kernel_cntrl_agent:rdata_fifo_sink_error
	wire          acl_kernel_clk_ctrl_agent_rdata_fifo_out_valid;                        // acl_kernel_clk_ctrl_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] acl_kernel_clk_ctrl_agent_rdata_fifo_out_data;                         // acl_kernel_clk_ctrl_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          acl_kernel_clk_ctrl_agent_rdata_fifo_out_ready;                        // avalon_st_adapter_002:in_0_ready -> acl_kernel_clk_ctrl_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                     // avalon_st_adapter_002:out_0_valid -> acl_kernel_clk_ctrl_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                      // avalon_st_adapter_002:out_0_data -> acl_kernel_clk_ctrl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                     // acl_kernel_clk_ctrl_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                     // avalon_st_adapter_002:out_0_error -> acl_kernel_clk_ctrl_agent:rdata_fifo_sink_error
	...
	system_acl_iface_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (version_id_clk_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (version_id_s_agent_rdata_fifo_out_data),           //     in_0.data
		.in_0_valid     (version_id_s_agent_rdata_fifo_out_valid),          //         .valid
		.in_0_ready     (version_id_s_agent_rdata_fifo_out_ready),          //         .ready
	...
	system_acl_iface_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (config_clk_out_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (version_id_clk_reset_reset_bridge_in_reset_reset),             // in_rst_0.reset
		.in_0_data      (acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (acl_kernel_interface_kernel_cntrl_agent_rdata_fifo_out_ready), //         .ready
